...
# Read the text file
with open('./Hospitality_Data/HospitalityReviews.txt', 'r', encoding='utf-8') as f:
    reviews = f.readlines()
...
WordsByEmotions(["negative", "anger", "fear", "disgust"])
...
# Read the csv file
df = pd.read_csv('./Hospitality_Data/hospitallity_creative.csv')
